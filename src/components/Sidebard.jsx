...
function Sidebard() {
    ...
    const sidebarDetails = [
        { title: "Dashbord", icon: <i class="fa-brands fa-dashcube"></i>, href: "/dashbord" },
                { title: "Attendence", icon: <i class="fa-brands fa-dashcube"></i>, href: "/attendence" },
                        { title: "Leave", icon: <i class="fa-brands fa-dashcube"></i>, href: "/leave" },
                                { title: "Payslip", icon: <i class="fa-brands fa-dashcube"></i>, href: "/payslip" },
                                        { title: "Settings", icon: <i class="fa-brands fa-dashcube"></i>, href: "/settings" }
  ...
  <div>
    ...
    {sidebarDetails.map((items, index) => (
      <NavLink
        ...
        to={items.href}
        className={({ isActive }) =>
          `flex items-center p-3 rounded-xl border-l-4 transition-all ${
            isActive
